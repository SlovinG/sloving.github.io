...
Maven仓库地址：[https://mvnrepository.com/artifact/org.mybatis.spring.boot/mybatis-spring-boot-starter/2.1.1](http://mybatis.org/spring-boot-starter/mybatis-spring-boot-autoconfigure/)
